...
//  alert('test');
    ...
    $('#tombol-tambah').click(function() {
        ...
        $('#modal-judul').html("Masukan Kode Bagan");
        $('#nama-label').html("Nama Kode Bagan");
    ...
    $(document).ready(function() {
        $('#tabel-kodeBagan').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('kodeBagan.index') }}",
                type: 'GET'
            },
            columns: [
                { data: 'kode_bagan', name: 'kode_bagan' },
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var reTable = $('#tabel-kodeBagan').dataTable();
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('kodeBagan/' + data_id + '/edit', function (data) {
            $('#modal-judul').html("Edit kode bagan");
            $('#tombol-simpan').val("edit-post");
            $('#tambah-edit').modal('show');

            //set value masing-masing id berdasarkan data yg diperoleh
            $('#id').val(data.id);
            $('#input_data').val(data.kode_bagan);
        })
    });
    ...
    $('#tombol-hapus').click(function () {
        $.ajax({
            ...
            url: "kodeBagan/" + dataId, //eksekusi ajax ke url
            type: 'delete',
            beforeSend: function () {
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#tabel-kodeBagan').dataTable();
