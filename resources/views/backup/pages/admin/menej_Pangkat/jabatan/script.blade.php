<script>
    ...
    $('#tombol-tambah').click(function() {
        ...
        $('#modal-judul').html("Masukan jabatan");
        $('#nama-label').html("Nama jabatan");
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var reTable = $('#tabel-jabatan').dataTable();
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('jabatan/' + data_id + '/edit', function (data) {
            ...
            $('#id').val(data.id);
            $('#input_data').val(data.nama_jabatan);
        })
    });
    ...
    $('#tombol-hapus').click(function () {
        $.ajax({
            ...
            url: "jabatan/" + dataId, //eksekusi ajax ke url
            type: 'delete',
            beforeSend: function () {
