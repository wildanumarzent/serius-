<script>
    ...
    $('#tombol-tambah').click(function() {
        ...
        $('#modal-judul').html("Masukan level");
        $('#nama-label').html("Nama level");
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var reTable = $('#tabel-level').dataTable();
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('level/' + data_id + '/edit', function (data) {
            $('#modal-judul').html("Edit level");
            $('#tombol-simpan').val("edit-post");
            $('#tambah-edit').modal('show');

            //set value masing-masing id berdasarkan data yg diperoleh
            $('#id').val(data.id);
            $('#input_data').val(data.level);
        })
    });
    ...
    $('#tombol-hapus').click(function () {
        $.ajax({
            ...
            url: "level/" + dataId, //eksekusi ajax ke url
            type: 'delete',
            beforeSend: function () {
            ...
            success: function (data) { //jika sukses
                setTimeout(function () {
                    ...
                    var oTable = $('#tabel-level').dataTable();
